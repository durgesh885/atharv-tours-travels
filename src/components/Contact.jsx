      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 grid sm:grid-cols-2 lg:grid-cols-1 gap-3.5">
            ...
            <a href="https://wa.me/919637886385?text=Hello%20Navneet%20ji,%20I%20want%20to%20inquire%20about%20cab%20rates." target="_blank" rel="noreferrer" className="p-4 sm:p-5 rounded-3xl bg-slate-50 hover:bg-emerald-50/70 border border-slate-200 hover:border-emerald-300 transition-all duration-300 flex items-start space-x-3.5 group shadow-sm block">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-tr from-emerald-500 to-green-600 text-white flex items-center justify-center text-lg shrink-0 shadow-md group-hover:scale-110 transition-transform">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h4 className="text-base sm:text-lg font-extrabold text-slate-900 mt-0.5 group-hover:text-emerald-600 transition-colors whitespace-nowrap">
                  +91 96378 86385
                </h4>
                <p className="text-xs text-slate-500 mt-0.5 font-medium whitespace-nowrap">Instant quotes & vehicle pictures</p>
              </div>
            </a>

            {/* Office Address Card */}
            <a href="https://maps.app.goo.gl/mdf1mMqxgSdgR5Ds7" target="_blank" rel="noreferrer" className="p-4 sm:p-5 rounded-3xl bg-slate-50 hover:bg-blue-50/70 border border-slate-200 hover:border-blue-300 transition-all duration-300 flex items-start space-x-3.5 group shadow-sm block">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-tr from-blue-500 to-indigo-600 text-white flex items-center justify-center text-lg shrink-0 shadow-md group-hover:scale-110 transition-transform">
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="text-[11px] text-blue-600 font-bold flex items-center gap-1 mt-1.5 group-hover:translate-x-0.5 transition-transform whitespace-nowrap">
            ...
            <a href="mailto:navnit9637@gmail.com" className="p-4 sm:p-5 rounded-3xl bg-slate-50 hover:bg-slate-100 border border-slate-200 transition-all duration-300 flex items-start space-x-3.5 group shadow-sm block">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-tr from-slate-800 to-slate-900 text-white flex items-center justify-center text-lg shrink-0 shadow-md">
                <Mail className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <div className="flex-1 min-w-0">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Corporate & Billing Inquiries</span>
                <h4 className="text-xs sm:text-sm font-bold text-slate-800 mt-0.5 whitespace-nowrap">navnit9637@gmail.com</h4>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-4">
            ...
            <div className="h-80 sm:h-[420px] bg-slate-100 rounded-3xl overflow-hidden border border-slate-200 relative shadow-md">
              ...
              <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-md border border-slate-200 text-xs font-bold text-slate-800 flex items-center gap-1.5 whitespace-nowrap">
                <MapPin className="w-3.5 h-3.5 text-orange-600" /> Medankarwadi, Chakan Hub
              </div>
            </div>

            {/* Bottom Action & Directions Banner */}
            <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white p-5 sm:p-6 rounded-3xl shadow-xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center space-x-3.5 text-center sm:text-left">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-orange-600/20 text-orange-400 border border-orange-500/30 flex items-center justify-center text-lg sm:text-xl shrink-0">
                  <MapPin className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-full sm:w-auto px-6 py-3.5 bg-orange-600 hover:bg-orange-700 text-white font-bold text-xs sm:text-sm rounded-2xl shadow-lg shadow-orange-600/30 transition flex items-center justify-center space-x-2 shrink-0 active:scale-98 whitespace-nowrap"
              >
