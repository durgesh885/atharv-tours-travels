        ...
        <div className="grid md:grid-cols-12 gap-8 mb-10 pb-8 border-b border-slate-800/80 items-start">
          ...
          <div className="md:col-span-5 space-y-3">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl overflow-hidden bg-slate-900 border border-orange-500/30 flex-shrink-0">
                <img src="/assets/images/logo.jpg" alt="Atharv Tours & Travels" className="w-full h-full object-cover" />
              </div>
              <div>
                <span className="text-base font-black text-white tracking-tight leading-none block">ATHARV <span className="text-orange-500">TRAVELS</span></span>
                <span className="text-[10px] text-slate-500 font-semibold tracking-wider uppercase">Pune • Chakan • All India Cabs</span>
              </div>
            </div>
          ...
          <div className="md:col-span-4 space-y-2.5">
            ...
            <a href="tel:+917507990227" className="flex items-center text-white hover:text-orange-400 transition font-bold text-xs sm:text-sm">
              <Phone className="w-3.5 h-3.5 text-orange-500 mr-2 flex-shrink-0" /> +91 75079 90227 <span className="text-[10px] font-normal text-slate-400 ml-1.5">(Navneet Patil)</span>
            </a>
            
            <a href="https://wa.me/919637886385?text=Hello%20Navneet%20ji,%20I%20want%20to%20book%20a%20cab." target="_blank" rel="noreferrer" className="flex items-center text-emerald-400 hover:text-emerald-300 transition font-bold text-xs sm:text-sm">
              <MessageCircle className="w-3.5 h-3.5 text-emerald-500 mr-2 flex-shrink-0" /> +91 96378 86385 <span className="text-[10px] font-normal text-slate-400 ml-1.5">(Instant Quote)</span>
            </a>
            
            <p className="text-[11px] text-slate-400 leading-snug pt-1 flex items-start">
              <MapPin className="w-3.5 h-3.5 text-orange-500 mr-2 mt-0.5 flex-shrink-0" />
