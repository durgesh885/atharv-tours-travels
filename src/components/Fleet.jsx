...
import { Users, Briefcase, Snowflake, Plane, Check, MessageCircle, Bus, ShieldCheck, Zap } from 'lucide-react';
  ...
  return (
    <section id="fleet" className="py-16 sm:py-24 bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-3xl border border-slate-200/90 overflow-hidden bg-white hover:shadow-2xl hover:border-orange-500/30 transition-all duration-300 flex flex-col justify-between shadow-sm group">
            <div>
              ...
              <div className="h-64 sm:h-72 bg-slate-100 relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-slate-900/90 backdrop-blur-md text-white text-xs px-3.5 py-1 rounded-full font-bold shadow-md">
                  Prime AC Sedan
                </div>
                <div className="absolute top-4 right-4 bg-emerald-600 text-white text-xs px-3.5 py-1 rounded-full font-bold shadow-md flex items-center gap-1">
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5">
                      <Users className="w-4 h-4 text-orange-500 flex-shrink-0" /> 4 Pass + 1 Driver
                    </p>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5">
                      <Briefcase className="w-4 h-4 text-blue-500 flex-shrink-0" /> 2-3 Large Bags
                    </p>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5">
                      <Snowflake className="w-4 h-4 text-cyan-500 flex-shrink-0" /> High-Cool AC
                    </p>
                  </div>

                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Best Suited For</span>
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5 truncate">
                      <Plane className="w-4 h-4 text-emerald-500 flex-shrink-0" /> Airport & City
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 pt-1 text-[11px] text-slate-600 font-medium">
                  <span className="bg-emerald-50 text-emerald-700 px-2.5 py-1 rounded-lg border border-emerald-100 flex items-center gap-1">
                    <Check className="w-3 h-3" /> 100% Sanitized
                  </span>
                  <span className="bg-blue-50 text-blue-700 px-2.5 py-1 rounded-lg border border-blue-100 flex items-center gap-1">
                    <Zap className="w-3 h-3" /> Fastag Enabled
                  </span>
                  <span className="bg-orange-50 text-orange-700 px-2.5 py-1 rounded-lg border border-orange-100 flex items-center gap-1">
                    <Check className="w-3 h-3" /> Mobile Charger
                  </span>
                  <span className="bg-slate-100 text-slate-700 px-2.5 py-1 rounded-lg border border-slate-200 flex items-center gap-1">
                    <Check className="w-3 h-3" /> Music System
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-3xl border-2 border-orange-500/40 overflow-hidden bg-white hover:shadow-2xl hover:border-orange-500 transition-all duration-300 flex flex-col justify-between shadow-sm relative group">
            ...
            <div>
              ...
              <div className="h-64 sm:h-72 bg-slate-100 relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-orange-600 text-white text-xs px-3.5 py-1 rounded-full font-bold shadow-md uppercase tracking-wider">
                  Family & Yatra Special
                </div>
                <div className="absolute top-4 right-4 bg-slate-900/90 backdrop-blur-md text-white text-xs px-3.5 py-1 rounded-full font-bold shadow-md">
                  6 + 1 Seats • Dual AC
                </div>
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Capacity</span>
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5">
                      <Users className="w-4 h-4 text-orange-500 flex-shrink-0" /> 6 Pass + 1 Driver
                    </p>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Luggage Space</span>
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5">
                      <Briefcase className="w-4 h-4 text-blue-500 flex-shrink-0" /> 4-5 Bags + Roof
                    </p>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Air Conditioning</span>
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5">
                      <Snowflake className="w-4 h-4 text-cyan-500 flex-shrink-0" /> Dual Front & Rear AC
                    </p>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-100">
                    <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Best Suited For</span>
                    <p className="text-xs sm:text-sm font-extrabold text-slate-800 mt-0.5 flex items-center gap-1.5 truncate">
                      <Plane className="w-4 h-4 text-amber-500 flex-shrink-0" /> Shirdi, Yatra & Goa
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 pt-1 text-[11px] text-slate-600 font-medium">
                  <span className="bg-emerald-50 text-emerald-700 px-2.5 py-1 rounded-lg border border-emerald-100 flex items-center gap-1">
                    <Check className="w-3 h-3" /> Pushback Seats
                  </span>
                  <span className="bg-blue-50 text-blue-700 px-2.5 py-1 rounded-lg border border-blue-100 flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3" /> All India Permit
                  </span>
                  <span className="bg-orange-50 text-orange-700 px-2.5 py-1 rounded-lg border border-orange-100 flex items-center gap-1">
                    <Snowflake className="w-3 h-3" /> Dual Chilled AC
                  </span>
                  <span className="bg-slate-100 text-slate-700 px-2.5 py-1 rounded-lg border border-slate-200 flex items-center gap-1">
                    <Check className="w-3 h-3" /> USB Charging
                  </span>
                </div>
              </div>
            </div>
        ...
        {/* Group Travel Note */}
        <div className="mt-12 sm:mt-16 max-w-5xl mx-auto bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white rounded-3xl p-7 sm:p-9 shadow-2xl border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-4">
            <div className="w-14 h-14 rounded-2xl bg-orange-600/20 text-orange-400 border border-orange-500/30 flex items-center justify-center text-2xl flex-shrink-0">
              <Bus className="w-7 h-7" />
            </div>
            <div>
              <div className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-orange-400 bg-orange-950/60 px-2.5 py-0.5 rounded-full border border-orange-500/30 mb-1">
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="w-full md:w-auto px-6 py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold rounded-2xl transition flex items-center justify-center space-x-2 flex-shrink-0 shadow-lg shadow-emerald-600/20 active:scale-98"
          >
            <MessageCircle className="w-4 h-4" />
